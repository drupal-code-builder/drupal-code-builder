...
class MergingGeneratorDefinition extends PropertyDefinition implements GeneratorDefinitionInterface {
   ...
   *   The new definition.
   */
  static public function createFromGeneratorType(string $generator_type): static {
  ...
  public function getProperties() {
    if (!$this->generatorPropertiesLoaded) {
      ...
      // thing MB's ComponentSectionForm does is call isComplex(), which in MTD
      // accesses $this->properties directly, so doesn't give lazy loading a
      // chance to act. TODO: Fix this in MTD.
