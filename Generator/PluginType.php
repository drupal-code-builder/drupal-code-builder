...
class PluginType extends BaseGenerator implements AdoptableInterface {
  ...
  public function requiredComponents(): array {
    ...
    $plugin_type = $this->component_data->plugin_type->value;
    ...
    $components['__construct'] = array(
      ...
      'doxygen_first' => "Constructs a new {$this->component_data->annotation_class->value}Manager object.",
    ...
    */
    ...
    if ($this->component_data->discovery_type->value == 'annotation') {
      $components['annotation'] = [
        ...
        'relative_class_name' => 'Annotation\\' . $this->component_data->annotation_class->value,
        'parent_class_name' => '\Drupal\Component\Annotation\Plugin',
        'class_docblock_lines' => [
          "Defines the {$this->component_data->plugin_label->value} plugin annotation object.",
          "Plugin namespace: {$this->component_data->plugin_relative_namespace->value}.",
        ],
        // TODO: Some annotation properties such as ID and label.
      ];
    }
    if ($this->component_data->discovery_type->value == 'attribute') {
      $components['attribute'] = [
        ...
        'class_docblock_lines' => [
          "Defines a {$this->component_data->plugin_label->value} attribute object.",
          "Plugin namespace: {$this->component_data->plugin_relative_namespace->value}.",
        ],
      ];
    ...
    $plugin_relative_namespace_pieces = explode('\\', $this->component_data->plugin_relative_namespace->value);

    $components['interface'] = [
      'component_type' => 'PHPInterfaceFile',
      'plain_class_name' => $this->component_data->plugin_plain_class_name->value . 'Interface',
      'relative_namespace' => 'Plugin\\' . $this->component_data->plugin_relative_namespace->value,
      'docblock_first_line' => "Interface for {$this->component_data->plugin_label->value} plugins.",
    ...
    $components['base_class'] = [
      ...
      'plain_class_name' => $this->component_data->base_class_short_name->value,
      'relative_namespace' => 'Plugin\\' . $this->component_data->plugin_relative_namespace->value,
      ...
      // this class.
      'abstract'=> (in_array($this->component_data->discovery_type->value, ['annotation', 'attribute'])),
      'docblock_first_line' => "Base class for {$this->component_data->plugin_label->value} plugins.",
    ];
    ...
    $components['plugin_type_yml'] = [
      ...
      'yaml_data' => [
        "{$module}.{$plugin_type}"=> [
          'label' => $this->component_data->plugin_label->value,
          'plugin_manager_service_id' => $this->component_data->plugin_manager_service_id->value,
    ...
    $components['api'] = [
     ...
     $components['alter_hook'] = [
      'component_type' => 'PHPFunction',
      'function_name' => "hook_{$this->component_data->info_alter_hook->value}_alter",
      'containing_component' => '%requester:api',
      'function_docblock_lines' => [
        "Perform alterations on {$this->component_data->plugin_label->value} definitions.",
      ],
      'parameters' => [
        [
          'name' => 'info',
          'by_reference' => TRUE,
          'typehint' => 'array',
          'description' => "Array of information on {$this->component_data->plugin_label->value} plugins.",
        ],
      ],
      'return' => [
