...
/**
 * Validates a YAML plugin ID.
 */
class YamlPluginName implements ValidatorInterface {
  ...
  public function message(DataItem $data): string {
    return "The @label may only contain lowercase letters, numbers, underscores, periods, and a colon.";
  }
